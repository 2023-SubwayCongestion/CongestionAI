...
class Transforms(object):
    ...
    def __call__(self, image, density):
        ...
        if random.random() < 0.5:
            ...
            density = ndimage.rotate(density, angle, reshape=False, order=0)
            # attention = ndimage.rotate(attention, angle, reshape=False, order=0)
        ...
        density = tensor(density, dtype=tfloat)
